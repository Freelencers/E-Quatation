...
class Pdf_quatation extends FPDF
{
  ...
  function Header(){
    $border_cell = 0;
		...
		$this->AddFont('times','B','times.php');
		$this->AddFont('times','I','times.php');
		$this->AddFont('times','U','times.php');
		$this->SetFont('times','',24);

		$this->SetTextColor(0,0,128);
		$this->SetTextColor(0,0,128);
		$this->Cell(210,10,iconv( 'UTF-8','TIS-620','OTEC SUPPLY COMPANY LIMITED'),$border_cell,1,"C");
