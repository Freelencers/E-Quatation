    ...
    <p class="login-box-msg">Sign in to system</p>
      <form id="login">
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-xs-4">
            <div class="btn btn-primary btn-block btn-flat" id="login_btn" >Sign In</div>
          </div>
          <!-- /.col -->
        </div>
      </form>
      <div class="row">
        <div class="col-xs-12">
          <center><a href="index.php/C_login/forget_password_view">Forgot Password</a></center>
        </div>
      </div>
  </div>
  <!-- /.login-box-body -->
