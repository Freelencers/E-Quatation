              ...
              <tbody>
                ...
                <tr 
                  ...
                  <td>
                    ...
                    <!-- i class="fa fa-fw fa-trash" style="color: red; cursor: pointer;"></i -->
                  </td>
                  <td>
                    <select class="form-control system_type" index="<?= $i ?>" id="system_type_<?= $i ?>">
...
<?php
  if($status == "ADD"){
    ...
    echo script_tag("js/add_project.js");
  }else if($status == "DETAIL"){
    echo script_tag("js/detail_project.js");
